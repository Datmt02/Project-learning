		...
		<div class="row p-3 border">
			<c:forEach items="${ cartValue }" var="cart">
				...
				<div class="col-4 ps-3 pt-4 border-start">
					<h4>Tên sản phẩm: ${ cart.product.name } </h4> 
					<h4>Giá thành: ${ cart.product.price } VND</h4> 
					<h4>Mô tả: ${ cart.product.mota }</h4> 
					<label>Số Lượng</label>
					<form:input type="number" path="available" class="form-control" name="available" value="${cart.available }" />
